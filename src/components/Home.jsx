   ...
   <div className="min-h-screen bg-gradient-to-br from-purple-100 via-white to-purple-200 flex flex-col ">
      {/* Hero Section */}
       ...
       <section className="mx-auto px-8 grid grid-cols-1 gap-6 w-3/5 flex-1 mb-5 mt-3">
        ...
        <div className="rounded-2xl shadow-lg p-6 border-t-4 border-purple-600 cursor-pointer hover:scale-105 transition-transform duration-200 flex flex-col items-center text-center" onClick={() => navigate('/register') }>
        ...
        <div className="rounded-2xl shadow-lg p-6 border-t-4 border-purple-700 cursor-pointer hover:scale-105 transition-transform duration-200 flex flex-col items-center text-center " onClick={() => navigate('/manage') }>
